...
## 当前迭代 · Iteration 37（Keeni Memory KM-05 · hybrid recall）

| ID | 项 | 状态 |
|----|-----|------|
| I37-01 | `searchMemoryChunks` 接入 FTS + Vector RRF | [ ] |
| I37-02 | Explorer/API 返回 fused score | [ ] |
| I37-03 | tests · roadmap · commit · push | [ ] |

**下一迭代**：KM-06 · summaries FTS
