...
Git hooks are installed automatically on `pnpm install`. The pre-commit hook runs `pnpm lint` before each commit; the commit-msg hook validates [Conventional Commits](https://www.conventionalcommits.org/) via commitlint. To reinstall manually:
